...
*/
var mergeTopDown = function (data, low, high) {
...
*/
var mergeBottomUp = function (data) {
...
*/
var quick = function (data) {
    var partition = function (low, high) {
        var aux = data.slice();
        var value = data[low];
        var left = low, right = high + 1;
        while (true) {
